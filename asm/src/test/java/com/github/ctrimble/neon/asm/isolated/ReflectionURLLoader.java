...
import com.github.ctrimble.neon.asm.Utils;
...
public class ReflectionURLLoader implements URLLoader
{
	public String loadUrl(String systemId) throws Exception {
		...
		String className = "com.github.ctrimble.neon.asm.isolated.IsolatedURLLoader";
		byte[] classBytes = Utils.getResourceBytes("/com/github/ctrimble/neon/asm/isolated/IsolatedURLLoader.class");
