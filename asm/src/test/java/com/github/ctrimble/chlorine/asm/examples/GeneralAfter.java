...
import java.net.URL;
import static com.github.ctrimble.chlorine.URLFactory.newURL;

public class GeneralAfter {
	public static final String SPEC = "http://ctrimble.github.com/chlorine";
	public static final String PROTOCOL = "http";
	public static final String HOST = "ctrimble.github.com";
	public static final int PORT = -1;
	public static final String PATH = "/chlorine";
