...
import static com.github.ctrimble.chlorine.asm.Utils.*;
...
public class ConstructorInMethodTest {
	...
	public void singleMethod() throws Exception {
		...
		Class<?> simpleClass = classLoader.translateAndDefineClass("com.github.ctrimble.chlorine.asm.SimpleURLLoader", simpleClassBytes);
