...
/**
 * A class visitor that translates all calls to new java.net.URL(...) into calls to com.github.ctrimble.chlorine.service.URLFactory.newURL(...).  This class does not
...
extends ClassVisitor
{
    ...
    private static String URL_FACTORY_NAME = "com/github/ctrimble/chlorine/URLFactory";
